...
- **Cases**, one test function each, exactly these names, nothing more:
  ...
  - `test_kind_and_state_from_labels`: story created with labels kind:story,state:waiting,owner:architect has kind 'story', state 'waiting', owner 'architect' and claimed_by ''
