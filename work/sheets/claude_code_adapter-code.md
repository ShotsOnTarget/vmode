...
- **How**: replace the whole file. Keep the module docstring saying this is the one file that names the harness. No PROMPT text in this file; the prompt lives in adapter_command. Under 40 lines.
