...
inputs: kind (one of intent, story, code, test, verification, validation, proposal, note), title (non-empty), owner (non-empty), parent (existing id, required unless kind is intent)
...
work item id: 0005-2-record_create_item-code
