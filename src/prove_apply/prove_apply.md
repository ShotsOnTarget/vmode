...
side effects: calls prove_move to apply the state/bounce/escalate effects; on action 'log_done' calls commit_job to land the change; appends one log line per gate (Built always, Proven when kind is 'test') to log_path.
