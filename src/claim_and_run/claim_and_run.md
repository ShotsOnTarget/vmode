...
side effects: claims the item, adds usage/release notes, sets state to checking/ready or (labels_absent columns) adds a label, clears the claim, and restores the item's prior state
